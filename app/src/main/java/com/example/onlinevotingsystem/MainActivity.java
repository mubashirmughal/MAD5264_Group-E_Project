...
public class MainActivity extends AppCompatActivity {
    ...
    private EditText firstName,lastName, aIDNumber;
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        aIDNumber = findViewById(R.id.IDNumber);
                ...
                public void onDataChange(@NonNull DataSnapshot snapshot) {
                    ...
                    if(snapshot.hasChild("hasSubmitted")){
                        if(snapshot.child("hasSubmitted").getValue().toString().equals("true")){
                            ...
                            String aIDNum = snapshot.child("aIDNum").getValue().toString();
        ...
        submitBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String aIDNum = aIDNumber.getText().toString();
                String gender = null;
                ...
                else if(aIDNum.trim().length() != 12){
                    Toast.makeText(getApplicationContext(),"ID Number must be a 12 digit number",Toast.LENGTH_LONG).show();
                    return;
                }else{
                    User curUser = new User(fName,lName,gender,dob,aIDNum,"true","false","",uid);
    ...
    public void putFileInStorage(final Uri file) {
        ...
        uploadTask = (UploadTask) upload.putFile(file).addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
            ...
            public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                Toast.makeText(MainActivity.this, "AID Image Upload Successfully!", Toast.LENGTH_SHORT).show();
