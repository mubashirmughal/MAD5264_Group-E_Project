...
public class ModuleTestStaticClasses {
    ...
    public void testVoter(){
        ...
        String aIDNum = "222244445555";
        String hasSubmitted = "false";
        String isVerified = "true";
        String message = "";
        String userId = "";
        User voter = new User(fName,lName,gender,dob,aIDNum,hasSubmitted,isVerified,message,userId);
        assertEquals(fName,voter.getfName());
        assertEquals(lName,voter.getlName());
        assertEquals(gender,voter.getGender());
        assertEquals(aIDNum,voter.getaIDNum());
    ...
    public void testCandidate(){
        ...
        String message = "";
        String userId = "";
        Candidate candidate = new Candidate(fName,lName,gender,pName,dob,aIDNum,hasSubmitted,isVerified,message,userId);
        ...
        assertEquals(aIDNum,candidate.getAIDNum());
